...
class Showservices(object):
    ...
    def loadconection(self):
        ...
        with db:
            cur = db.cursor()
            rows = cur.execute("""select * from services""")
            data = cur.fetchall()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['ID_Service', 'Service_name', 'Date', 'Incoming_city','Minute_cost','Preferential_cost',])
