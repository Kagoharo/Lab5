...
class Showpayment(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['ID_Payment', 'Date', 'Notification_number', 'Receipt_number','Payment_status','bill',])
