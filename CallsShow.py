...
class Showcalls(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setHorizontalHeaderLabels(['ID_Call', 'Duration', 'Date', 'Outgoing_number','Outgoing_city','Incoming_city','Incoming_number',])
